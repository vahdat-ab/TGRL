 ...
 * <ul>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.SoftgoalImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.SoftgoalImpl#getDecompositionType <em>Decomposition Type</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.SoftgoalImpl#getImportance <em>Importance</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.SoftgoalImpl#getImportanceQuantitative <em>Importance Quantitative</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.SoftgoalImpl#getElementLinks <em>Element Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SoftgoalImpl extends IntentionalElementImpl implements Softgoal
{
  ...
  {
    return TGRLPackage.Literals.SOFTGOAL;
  }
  ...
  public void setFillColor(Color newFillColor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.SOFTGOAL__FILL_COLOR, oldFillColor, fillColor));
  }
  ...
  public void setDecompositionType(DecompositionType newDecompositionType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.SOFTGOAL__DECOMPOSITION_TYPE, oldDecompositionType, decompositionType));
  }
  ...
  public void setImportance(ImportanceType newImportance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.SOFTGOAL__IMPORTANCE, oldImportance, importance));
  }
  ...
  public void setImportanceQuantitative(int newImportanceQuantitative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.SOFTGOAL__IMPORTANCE_QUANTITATIVE, oldImportanceQuantitative, importanceQuantitative));
  }
  ...
  public EList<InLineElementLink> getElementLinks()
  {
    ...
    {
      elementLinks = new EObjectContainmentEList<InLineElementLink>(InLineElementLink.class, this, TGRLPackage.SOFTGOAL__ELEMENT_LINKS);
    }
    return elementLinks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TGRLPackage.SOFTGOAL__ELEMENT_LINKS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TGRLPackage.SOFTGOAL__FILL_COLOR:
        return getFillColor();
      case TGRLPackage.SOFTGOAL__DECOMPOSITION_TYPE:
        return getDecompositionType();
      case TGRLPackage.SOFTGOAL__IMPORTANCE:
        return getImportance();
      case TGRLPackage.SOFTGOAL__IMPORTANCE_QUANTITATIVE:
