 ...
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.GoalImpl#getElementLinks <em>Element Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GoalImpl extends IntentionalElementImpl implements Goal
{
  ...
  public void setDecompositionType(DecompositionType newDecompositionType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.GOAL__DECOMPOSITION_TYPE, oldDecompositionType, decompositionType));
  }
  ...
  public void setImportance(ImportanceType newImportance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.GOAL__IMPORTANCE, oldImportance, importance));
  }
  ...
  public void setImportanceQuantitative(int newImportanceQuantitative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.GOAL__IMPORTANCE_QUANTITATIVE, oldImportanceQuantitative, importanceQuantitative));
  }
  ...
  public EList<InLineElementLink> getElementLinks()
  {
    ...
    {
      elementLinks = new EObjectContainmentEList<InLineElementLink>(InLineElementLink.class, this, TGRLPackage.GOAL__ELEMENT_LINKS);
    }
    return elementLinks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TGRLPackage.GOAL__ELEMENT_LINKS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case TGRLPackage.GOAL__IMPORTANCE_QUANTITATIVE:
