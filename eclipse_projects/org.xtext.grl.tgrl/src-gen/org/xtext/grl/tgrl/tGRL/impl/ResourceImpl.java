 ...
 * <ul>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.ResourceImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.ResourceImpl#getDecompositionType <em>Decomposition Type</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.ResourceImpl#getImportance <em>Importance</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.ResourceImpl#getImportanceQuantitative <em>Importance Quantitative</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.ResourceImpl#getElementLinks <em>Element Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceImpl extends IntentionalElementImpl implements Resource
{
  ...
  {
    return TGRLPackage.Literals.RESOURCE;
  }
  ...
  public void setFillColor(Color newFillColor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.RESOURCE__FILL_COLOR, oldFillColor, fillColor));
  }
  ...
  public void setDecompositionType(DecompositionType newDecompositionType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.RESOURCE__DECOMPOSITION_TYPE, oldDecompositionType, decompositionType));
  }
  ...
  public void setImportance(ImportanceType newImportance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.RESOURCE__IMPORTANCE, oldImportance, importance));
  }
  ...
  public void setImportanceQuantitative(int newImportanceQuantitative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.RESOURCE__IMPORTANCE_QUANTITATIVE, oldImportanceQuantitative, importanceQuantitative));
  }
  ...
  public EList<InLineElementLink> getElementLinks()
  {
    ...
    {
      elementLinks = new EObjectContainmentEList<InLineElementLink>(InLineElementLink.class, this, TGRLPackage.RESOURCE__ELEMENT_LINKS);
    }
    return elementLinks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TGRLPackage.RESOURCE__ELEMENT_LINKS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TGRLPackage.RESOURCE__FILL_COLOR:
        return getFillColor();
      case TGRLPackage.RESOURCE__DECOMPOSITION_TYPE:
        return getDecompositionType();
      case TGRLPackage.RESOURCE__IMPORTANCE:
        return getImportance();
      case TGRLPackage.RESOURCE__IMPORTANCE_QUANTITATIVE:
