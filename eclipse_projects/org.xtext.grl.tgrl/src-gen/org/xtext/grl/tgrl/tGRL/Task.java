 ...
 * <ul>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Task#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Task#getDecompositionType <em>Decomposition Type</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Task#getImportance <em>Importance</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Task#getImportanceQuantitative <em>Importance Quantitative</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Task#getElementLinks <em>Element Links</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Task extends IntentionalElement
{
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getTask_FillColor()
   * @model
   * @generated
   */
  Color getFillColor();
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Task#getFillColor <em>Fill Color</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getTask_DecompositionType()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Task#getDecompositionType <em>Decomposition Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getTask_Importance()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Task#getImportance <em>Importance</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getTask_ImportanceQuantitative()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Task#getImportanceQuantitative <em>Importance Quantitative</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getTask_ElementLinks()
