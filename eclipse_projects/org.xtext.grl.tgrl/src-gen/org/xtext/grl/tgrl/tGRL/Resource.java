 ...
 * <ul>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Resource#getFillColor <em>Fill Color</em>}</li>
...
public interface Resource extends IntentionalElement
{
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getResource_FillColor()
   * @model
   * @generated
   */
  Color getFillColor();
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Resource#getFillColor <em>Fill Color</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
