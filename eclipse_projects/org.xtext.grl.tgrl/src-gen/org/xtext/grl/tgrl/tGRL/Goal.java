 ...
 * <ul>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Goal#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Goal#getDecompositionType <em>Decomposition Type</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Goal#getImportance <em>Importance</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Goal#getImportanceQuantitative <em>Importance Quantitative</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Goal#getElementLinks <em>Element Links</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Goal extends IntentionalElement
{
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getGoal_FillColor()
   * @model
   * @generated
   */
  Color getFillColor();
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Goal#getFillColor <em>Fill Color</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getGoal_DecompositionType()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Goal#getDecompositionType <em>Decomposition Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getGoal_Importance()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Goal#getImportance <em>Importance</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getGoal_ImportanceQuantitative()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Goal#getImportanceQuantitative <em>Importance Quantitative</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getGoal_ElementLinks()
