 ...
 * <ul>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Softgoal#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Softgoal#getDecompositionType <em>Decomposition Type</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Softgoal#getImportance <em>Importance</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Softgoal#getImportanceQuantitative <em>Importance Quantitative</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.Softgoal#getElementLinks <em>Element Links</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getSoftgoal()
 * @model
 * @generated
 */
public interface Softgoal extends IntentionalElement
{
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getSoftgoal_FillColor()
   * @model
   * @generated
   */
  Color getFillColor();
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Softgoal#getFillColor <em>Fill Color</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getSoftgoal_DecompositionType()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Softgoal#getDecompositionType <em>Decomposition Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getSoftgoal_Importance()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Softgoal#getImportance <em>Importance</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getSoftgoal_ImportanceQuantitative()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.grl.tgrl.tGRL.Softgoal#getImportanceQuantitative <em>Importance Quantitative</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.grl.tgrl.tGRL.TGRLPackage#getSoftgoal_ElementLinks()
