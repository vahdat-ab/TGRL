 ...
 * <ul>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.DependencyEndImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class DependencyEndImpl extends MinimalEObjectImpl.Container implements DependencyEnd
{
  /**
    ...
    if (name != null && name.eIsProxy())
    {
      ...
      if (name != oldName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TGRLPackage.DEPENDENCY_END__NAME, oldName, name));
      }
    }
    return name;
  }
  ...
  public void setName(IntentionalElement newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.DEPENDENCY_END__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TGRLPackage.DEPENDENCY_END__NAME:
