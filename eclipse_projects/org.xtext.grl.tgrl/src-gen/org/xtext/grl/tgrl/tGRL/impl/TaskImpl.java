 ...
 * <ul>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.TaskImpl#getFillColor <em>Fill Color</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.TaskImpl#getDecompositionType <em>Decomposition Type</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.TaskImpl#getImportance <em>Importance</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.TaskImpl#getImportanceQuantitative <em>Importance Quantitative</em>}</li>
 *   <li>{@link org.xtext.grl.tgrl.tGRL.impl.TaskImpl#getElementLinks <em>Element Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaskImpl extends IntentionalElementImpl implements Task
{
  ...
  public void setFillColor(Color newFillColor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.TASK__FILL_COLOR, oldFillColor, fillColor));
  }
  ...
  public void setDecompositionType(DecompositionType newDecompositionType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.TASK__DECOMPOSITION_TYPE, oldDecompositionType, decompositionType));
  }
  ...
  public void setImportance(ImportanceType newImportance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.TASK__IMPORTANCE, oldImportance, importance));
  }
  ...
  public void setImportanceQuantitative(int newImportanceQuantitative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TGRLPackage.TASK__IMPORTANCE_QUANTITATIVE, oldImportanceQuantitative, importanceQuantitative));
  }
  ...
  public EList<InLineElementLink> getElementLinks()
  {
    ...
    {
      elementLinks = new EObjectContainmentEList<InLineElementLink>(InLineElementLink.class, this, TGRLPackage.TASK__ELEMENT_LINKS);
    }
    return elementLinks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TGRLPackage.TASK__ELEMENT_LINKS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TGRLPackage.TASK__FILL_COLOR:
        return getFillColor();
      case TGRLPackage.TASK__DECOMPOSITION_TYPE:
        return getDecompositionType();
      case TGRLPackage.TASK__IMPORTANCE:
        return getImportance();
      case TGRLPackage.TASK__IMPORTANCE_QUANTITATIVE:
