...
public class DivisionOfLabourImpl extends MediatingElementImpl implements DivisionOfLabour {
	 ...
	 * @ordered
	 */
	protected EList<ASDiagram> refinedDiagrams;
	...
	public EList<Rule> getRules() {
		if (rules == null) {
			rules = new EObjectWithInverseResolvingEList.ManyInverse<Rule>(Rule.class, this, AsdPackage.DIVISION_OF_LABOUR__RULES, AsdPackage.RULE__DOLS);
		}
		return rules;
	}
	 ...
	 * @generated
	 */
	public EList<ASDiagram> getRefinedDiagrams() {
		if (refinedDiagrams == null) {
			refinedDiagrams = new EObjectWithInverseResolvingEList.ManyInverse<ASDiagram>(ASDiagram.class, this, AsdPackage.DIVISION_OF_LABOUR__REFINED_DIAGRAMS, AsdPackage.AS_DIAGRAM__PARENT_DO_LS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AsdPackage.DIVISION_OF_LABOUR__REFINED_DIAGRAMS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRefinedDiagrams()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AsdPackage.DIVISION_OF_LABOUR__REFINED_DIAGRAMS:
				...
				getRefinedDiagrams().addAll((Collection<? extends ASDiagram>)newValue);
				return;
			case AsdPackage.DIVISION_OF_LABOUR__PERFORMED_BY:
