...
public class OutcomeImpl extends ASDelementImpl implements Outcome {
	 ...
	 * @ordered
	 */
	protected EList<ASDelement> enabledElements;
	 ...
	 * @generated
	 */
	public EList<ASDelement> getEnabledElements() {
		if (enabledElements == null) {
			enabledElements = new EObjectWithInverseResolvingEList.ManyInverse<ASDelement>(ASDelement.class, this, AsdPackage.OUTCOME__ENABLED_ELEMENTS, AsdPackage.AS_DELEMENT__REQUIRED_OUTCOMES);
		}
	...
	public EList<asd.Object> getObjects() {
		if (objects == null) {
			objects = new EObjectWithInverseResolvingEList.ManyInverse<asd.Object>(asd.Object.class, this, AsdPackage.OUTCOME__OBJECTS, AsdPackage.OBJECT__OUTCOMES);
		}
		return objects;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AsdPackage.OUTCOME__ENABLED_ELEMENTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getEnabledElements()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case AsdPackage.OUTCOME__ENABLED_ELEMENTS:
				...
				getEnabledElements().addAll((Collection<? extends ASDelement>)newValue);
				return;
			case AsdPackage.OUTCOME__ASD_SPEC:
