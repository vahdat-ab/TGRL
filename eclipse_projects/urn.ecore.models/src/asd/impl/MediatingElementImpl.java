...
public abstract class MediatingElementImpl extends ASDelementImpl implements MediatingElement {
	...
	public EList<Mediation> getMediations() {
		if (mediations == null) {
			mediations = new EObjectWithInverseResolvingEList<Mediation>(Mediation.class, this, AsdPackage.MEDIATING_ELEMENT__MEDIATIONS, AsdPackage.MEDIATION__MEDIATED_BY);
		}
		return mediations;
	}
