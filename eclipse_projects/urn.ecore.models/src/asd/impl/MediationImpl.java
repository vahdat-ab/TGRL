...
public class MediationImpl extends ASDmodelElementImpl implements Mediation {
	 ...
	 * @ordered
	 */
	protected EList<MediatedElement> mediates;
	 ...
	 * @generated
	 */
	public EList<MediatedElement> getMediates() {
		if (mediates == null) {
			mediates = new EObjectWithInverseResolvingEList.ManyInverse<MediatedElement>(MediatedElement.class, this, AsdPackage.MEDIATION__MEDIATES, AsdPackage.MEDIATED_ELEMENT__MEDIATIONS);
		}
		return mediates;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AsdPackage.MEDIATION__MEDIATES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getMediates()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AsdPackage.MEDIATION__MEDIATES:
				getMediates().clear();
				getMediates().addAll((Collection<? extends MediatedElement>)newValue);
				return;
			case AsdPackage.MEDIATION__RELEVANT_ASD:
