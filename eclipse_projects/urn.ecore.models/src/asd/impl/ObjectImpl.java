...
public class ObjectImpl extends MediatedElementImpl implements asd.Object {
	...
	public EList<Outcome> getOutcomes() {
		if (outcomes == null) {
			outcomes = new EObjectWithInverseResolvingEList.ManyInverse<Outcome>(Outcome.class, this, AsdPackage.OBJECT__OUTCOMES, AsdPackage.OUTCOME__OBJECTS);
		}
		return outcomes;
	}
	...
	public EList<Subject> getSubjects() {
		if (subjects == null) {
			subjects = new EObjectWithInverseResolvingEList.ManyInverse<Subject>(Subject.class, this, AsdPackage.OBJECT__SUBJECTS, AsdPackage.SUBJECT__OBJECTS);
		}
		return subjects;
	}
