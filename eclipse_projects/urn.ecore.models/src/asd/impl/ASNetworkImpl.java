...
public class ASNetworkImpl extends MinimalEObjectImpl.Container implements ASNetwork {
	 ...
	 * @ordered
	 */
	protected EList<ASDspec> asDspec;
	...
	public EList<IURNNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentWithInverseEList<IURNNode>(IURNNode.class, this, AsdPackage.AS_NETWORK__NODES, UrncorePackage.IURN_NODE__DIAGRAM);
		}
		return nodes;
	}
	...
	public EList<IURNContainerRef> getContRefs() {
		if (contRefs == null) {
			contRefs = new EObjectContainmentWithInverseEList<IURNContainerRef>(IURNContainerRef.class, this, AsdPackage.AS_NETWORK__CONT_REFS, UrncorePackage.IURN_CONTAINER_REF__DIAGRAM);
		}
		return contRefs;
	}
	...
	public EList<IURNConnection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentWithInverseEList<IURNConnection>(IURNConnection.class, this, AsdPackage.AS_NETWORK__CONNECTIONS, UrncorePackage.IURN_CONNECTION__DIAGRAM);
		}
		return connections;
	}
	...
	public EList<Comment> getComments() {
		if (comments == null) {
			comments = new EObjectContainmentWithInverseEList<Comment>(Comment.class, this, AsdPackage.AS_NETWORK__COMMENTS, UrncorePackage.COMMENT__DIAGRAM);
		}
		return comments;
	}
	 ...
	 * @generated
	 */
	public EList<ASDspec> getASDspec() {
		if (asDspec == null) {
			asDspec = new EObjectWithInverseResolvingEList.ManyInverse<ASDspec>(ASDspec.class, this, AsdPackage.AS_NETWORK__AS_DSPEC, AsdPackage.AS_DSPEC__AS_NETWORK);
		}
		return asDspec;
	}
	...
	public EList<ASDlayout> getAsdLayouts() {
		if (asdLayouts == null) {
			asdLayouts = new EObjectContainmentWithInverseEList<ASDlayout>(ASDlayout.class, this, AsdPackage.AS_NETWORK__ASD_LAYOUTS, AsdPackage.AS_DLAYOUT__AS_NETWORK);
		}
		return asdLayouts;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AsdPackage.AS_NETWORK__AS_DSPEC:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getASDspec()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AsdPackage.AS_NETWORK__AS_DSPEC:
				getASDspec().clear();
				getASDspec().addAll((Collection<? extends ASDspec>)newValue);
				return;
			case AsdPackage.AS_NETWORK__ASD_LAYOUTS:
				getAsdLayouts().clear();
