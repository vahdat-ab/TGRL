...
public abstract class MediatedElementImpl extends ASDelementImpl implements MediatedElement {
	...
	public EList<Mediation> getMediations() {
		if (mediations == null) {
			mediations = new EObjectWithInverseResolvingEList.ManyInverse<Mediation>(Mediation.class, this, AsdPackage.MEDIATED_ELEMENT__MEDIATIONS, AsdPackage.MEDIATION__MEDIATES);
		}
		return mediations;
	}
