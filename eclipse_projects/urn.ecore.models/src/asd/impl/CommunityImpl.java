...
public class CommunityImpl extends MediatedElementImpl implements Community {
	 ...
	 * @ordered
	 */
	protected EList<DivisionOfLabour> performs;
	 ...
	 * @generated
	 */
	public EList<DivisionOfLabour> getPerforms() {
		if (performs == null) {
			performs = new EObjectWithInverseResolvingEList<DivisionOfLabour>(DivisionOfLabour.class, this, AsdPackage.COMMUNITY__PERFORMS, AsdPackage.DIVISION_OF_LABOUR__PERFORMED_BY);
		}
		return performs;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case AsdPackage.COMMUNITY__PERFORMS:
				getPerforms().clear();
				getPerforms().addAll((Collection<? extends DivisionOfLabour>)newValue);
				return;
			case AsdPackage.COMMUNITY__ASD_SPEC:
