...
public class ASDiagramImpl extends ASDmodelElementImpl implements ASDiagram {
	 ...
	 * @ordered
	 */
	protected EList<ASDelement> elements;
	 ...
	 * @ordered
	 */
	protected EList<ASDiagram> relatedASD;
	 ...
	 * @ordered
	 */
	protected EList<ASDlayout> asdLayouts;
	 ...
	 * @ordered
	 */
	protected EList<DivisionOfLabour> parentDoLs;
	...
	public EList<IURNNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentWithInverseEList<IURNNode>(IURNNode.class, this, AsdPackage.AS_DIAGRAM__NODES, UrncorePackage.IURN_NODE__DIAGRAM);
		}
		return nodes;
	}
	...
	public EList<IURNContainerRef> getContRefs() {
		if (contRefs == null) {
			contRefs = new EObjectContainmentWithInverseEList<IURNContainerRef>(IURNContainerRef.class, this, AsdPackage.AS_DIAGRAM__CONT_REFS, UrncorePackage.IURN_CONTAINER_REF__DIAGRAM);
		}
		return contRefs;
	}
	...
	public EList<IURNConnection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentWithInverseEList<IURNConnection>(IURNConnection.class, this, AsdPackage.AS_DIAGRAM__CONNECTIONS, UrncorePackage.IURN_CONNECTION__DIAGRAM);
		}
		return connections;
	}
	...
	public EList<Comment> getComments() {
		if (comments == null) {
			comments = new EObjectContainmentWithInverseEList<Comment>(Comment.class, this, AsdPackage.AS_DIAGRAM__COMMENTS, UrncorePackage.COMMENT__DIAGRAM);
		}
		return comments;
	}
	 ...
	 * @generated
	 */
	public EList<ASDelement> getElements() {
		if (elements == null) {
			elements = new EObjectWithInverseResolvingEList.ManyInverse<ASDelement>(ASDelement.class, this, AsdPackage.AS_DIAGRAM__ELEMENTS, AsdPackage.AS_DELEMENT__DIAGRAMS);
		}
		return elements;
	}
	 ...
	 * @generated
	 */
	public EList<ASDiagram> getASD() {
		if (asd == null) {
			asd = new EObjectWithInverseResolvingEList.ManyInverse<ASDiagram>(ASDiagram.class, this, AsdPackage.AS_DIAGRAM__ASD, AsdPackage.AS_DIAGRAM__RELATED_ASD);
		}
		return asd;
	}
	 ...
	 * @generated
	 */
	public EList<ASDiagram> getRelatedASD() {
		if (relatedASD == null) {
			relatedASD = new EObjectWithInverseResolvingEList.ManyInverse<ASDiagram>(ASDiagram.class, this, AsdPackage.AS_DIAGRAM__RELATED_ASD, AsdPackage.AS_DIAGRAM__ASD);
		}
		return relatedASD;
	}
	...
	public EList<Mediation> getMediations() {
		if (mediations == null) {
			mediations = new EObjectContainmentWithInverseEList<Mediation>(Mediation.class, this, AsdPackage.AS_DIAGRAM__MEDIATIONS, AsdPackage.MEDIATION__RELEVANT_ASD);
		}
		return mediations;
	}
	 ...
	 * @generated
	 */
	public EList<ASDlayout> getAsdLayouts() {
		if (asdLayouts == null) {
			asdLayouts = new EObjectWithInverseResolvingEList<ASDlayout>(ASDlayout.class, this, AsdPackage.AS_DIAGRAM__ASD_LAYOUTS, AsdPackage.AS_DLAYOUT__AS_DIAGRAM);
		}
		return asdLayouts;
	}
	 ...
	 * @generated
	 */
	public EList<DivisionOfLabour> getParentDoLs() {
		if (parentDoLs == null) {
			parentDoLs = new EObjectWithInverseResolvingEList.ManyInverse<DivisionOfLabour>(DivisionOfLabour.class, this, AsdPackage.AS_DIAGRAM__PARENT_DO_LS, AsdPackage.DIVISION_OF_LABOUR__REFINED_DIAGRAMS);
		}
		return parentDoLs;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AsdPackage.AS_DIAGRAM__ASD:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getASD()).basicAdd(otherEnd, msgs);
			case AsdPackage.AS_DIAGRAM__RELATED_ASD:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRelatedASD()).basicAdd(otherEnd, msgs);
			...
			case AsdPackage.AS_DIAGRAM__ASD_LAYOUTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAsdLayouts()).basicAdd(otherEnd, msgs);
			case AsdPackage.AS_DIAGRAM__PARENT_DO_LS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getParentDoLs()).basicAdd(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AsdPackage.AS_DIAGRAM__ELEMENTS:
				getElements().clear();
				getElements().addAll((Collection<? extends ASDelement>)newValue);
				return;
			case AsdPackage.AS_DIAGRAM__ASD:
				getASD().clear();
				getASD().addAll((Collection<? extends ASDiagram>)newValue);
				return;
			case AsdPackage.AS_DIAGRAM__RELATED_ASD:
				getRelatedASD().clear();
				getRelatedASD().addAll((Collection<? extends ASDiagram>)newValue);
				return;
			case AsdPackage.AS_DIAGRAM__MEDIATIONS:
				getMediations().clear();
			...
			case AsdPackage.AS_DIAGRAM__ASD_LAYOUTS:
				getAsdLayouts().clear();
				getAsdLayouts().addAll((Collection<? extends ASDlayout>)newValue);
				return;
			case AsdPackage.AS_DIAGRAM__PARENT_DO_LS:
				getParentDoLs().clear();
				getParentDoLs().addAll((Collection<? extends DivisionOfLabour>)newValue);
				return;
		}
