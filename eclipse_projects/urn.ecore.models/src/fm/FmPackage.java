...
public interface FmPackage extends EPackage {
	...
	/**
	 * The number of operations of the '<em>Feature Diagram</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FEATURE_DIAGRAM_OPERATION_COUNT = GrlPackage.GRL_GRAPH_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FEATURE___ADD_FEATURE__INT_STRING_COREFEATURERELATIONSHIPTYPE = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FEATURE___DELETE = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 1;
	 ...
	 * @ordered
	 */
	int FEATURE___RENAME__STRING = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FEATURE___CHANGE_LINK__COREFEATURERELATIONSHIPTYPE = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 3;
	 ...
	 * @ordered
	 */
	int FEATURE___CHANGE_PARENT__COREFEATURE_COREFEATURERELATIONSHIPTYPE = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 4;
	 ...
	 * @ordered
	 */
	int FEATURE___REQUIRES__COREFEATURE = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 5;
	 ...
	 * @ordered
	 */
	int FEATURE___EXCLUDES__COREFEATURE = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 6;
	 ...
	 * @ordered
	 */
	int FEATURE___REMOVE_CONSTRAINT__COREFEATURE = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 7;
	 ...
	 * @ordered
	 */
	int FEATURE___ADD_REALIZED_BY__COREMODEL = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 8;
	 ...
	 * @ordered
	 */
	int FEATURE___ASSOCIATE_REUSE__COREREUSE_ELIST_ELIST = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 9;
	 ...
	 * @ordered
	 */
	int FEATURE_OPERATION_COUNT = GrlPackage.INTENTIONAL_ELEMENT_OPERATION_COUNT + 10;
	...
	/**
	 * The number of operations of the '<em>Mandatory FM Link</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MANDATORY_FM_LINK_OPERATION_COUNT = GrlPackage.CONTRIBUTION_OPERATION_COUNT + 0;
	...
	/**
	 * The number of operations of the '<em>Optional FM Link</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int OPTIONAL_FM_LINK_OPERATION_COUNT = GrlPackage.CONTRIBUTION_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FEATURE_MODEL___GET_GLOBAL_ROOT = CorePackage.CORE_FEATURE_MODEL___GET_GLOBAL_ROOT;
	 ...
	 * @ordered
	 */
	int FEATURE_MODEL___GET_LOCAL_ROOT = CorePackage.CORE_FEATURE_MODEL___GET_LOCAL_ROOT;
	 ...
	 * @ordered
	 */
	int FEATURE_MODEL_OPERATION_COUNT = CorePackage.CORE_FEATURE_MODEL_OPERATION_COUNT + 0;
