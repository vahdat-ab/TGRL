...
public class UCMmapImpl extends UCMmodelElementImpl implements UCMmap {
	...
	public EList<COREModelReuse> getModelReuse() {
		if (modelReuse == null) {
			modelReuse = new EObjectContainmentEList<COREModelReuse>(COREModelReuse.class, this, MapPackage.UC_MMAP__MODEL_REUSE);
		}
		return modelReuse;
	}
	...
	public EList<COREModelElement> getModelElements() {
		if (modelElements == null) {
			modelElements = new EObjectResolvingEList<COREModelElement>(COREModelElement.class, this, MapPackage.UC_MMAP__MODEL_ELEMENTS);
		}
	...
	public EList<COREFeature> getRealizes() {
		if (realizes == null) {
			realizes = new EObjectWithInverseResolvingEList.ManyInverse<COREFeature>(COREFeature.class, this, MapPackage.UC_MMAP__REALIZES, CorePackage.CORE_FEATURE__REALIZED_BY);
		}
		return realizes;
	}
