...
public interface ScenarioPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int VARIABLE_OPERATION_COUNT = UrncorePackage.UC_MMODEL_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SCENARIO_DEF_OPERATION_COUNT = UrncorePackage.UC_MMODEL_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SCENARIO_GROUP_OPERATION_COUNT = UrncorePackage.UC_MMODEL_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ENUMERATION_TYPE_OPERATION_COUNT = UrncorePackage.UC_MMODEL_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SCENARIO_START_POINT_OPERATION_COUNT = 0;
	 ...
	 * @ordered
	 */
	int SCENARIO_END_POINT_OPERATION_COUNT = 0;
